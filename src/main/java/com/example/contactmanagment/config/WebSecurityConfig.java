package com.example.contactmanagment.config;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public WebSecurityConfig(UserRegistrationServiceImpl userService, BCryptPasswordEncoder bCryptPasswordEncoder) {
